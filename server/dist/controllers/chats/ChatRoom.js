...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var decoded, userRepository, user, chatRepository, chat;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                return [3 /*break*/, 7];
            case 4: return [4 /*yield*/, (0, typeorm_1.getRepository)(chats_1.chats)];
            case 5:
                chatRepository = _a.sent();
            ...
            case 6:
                chat = _a.sent();
                res.status(200).json({ chat: chat, nickName: user.nickname });
                _a.label = 7;
