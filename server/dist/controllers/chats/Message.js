...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, chatRepository, chat, reservationRepository, post, postRepository, userId;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = Number(req.params.roomId);
                chatRepository = (0, typeorm_1.getRepository)(chats_1.chats);
                return [4 /*yield*/, chatRepository
            ...
            case 2:
                ...
                return [4 /*yield*/, postRepository
                        ...
                        .select('users_id')
                        .where('post.id = :id', { id: post === null || post === void 0 ? void 0 : post.posts_id.id })
                        .getRawOne()];
            case 3:
                userId = _a.sent();
                res.status(200).json({ chat: chat.chat, post: post, userId: userId });
                return [2 /*return*/];
        }
    });
}); });
