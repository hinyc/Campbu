...
exports.default = {
    patch: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var decoded, userRepository, user, reservationId, reservation_status, reservationRepository;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, reservationRepository.update(reservationId, { reservation_status: reservation_status })];
                case 5:
                    _a.sent();
                    res
                        .status(200)
    ...
    delete: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var decoded, userRepository, user, reservationId, reservationRepository;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, AuthorizeToken_1.authorizeToken)(req, res)];
                case 1:
                ...
                case 4:
                    reservationId = Number(req.params.reservationId);
                    reservationRepository = (0, typeorm_1.getRepository)(reservation_1.reservation);
                    return [4 /*yield*/, reservationRepository.delete(reservationId)];
                case 5:
                    _a.sent();
